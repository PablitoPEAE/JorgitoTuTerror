...
document.getElementById('siBtn').addEventListener('click', function() {
    ...
    document.getElementById('bloquearBtn').style.display = 'none';
...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noButtonState) {
        ...
        case 15:
            ...
            // Hacer que el botón "Sí" crezca
            document.getElementId('siBtn').style.fontSize = '280px';
...
document.getElementById('bloquearBtn').addEventListener('click', function() {
    document.getElementById('blockGifContainer').style.display = 'block';
    document.getElementById('question2').style.display = 'none';
    document.getElementById('gifContainer').style.display = 'none';
    document.getElementById('happyGifContainer').style.display = 'none';
    document.getElementById('happyGifContainer2').style.display = 'none';
